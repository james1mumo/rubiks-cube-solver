...
def set_front_face(front_face):
    ...
    old_front_face = copy.deepcopy(current_front_face)
...
def move_right_inverse(front_face):
...
def draw_cube(front_face):
    ...
    face_images = []
    for face in cube:
        face_top_img = append_images([colors[faces.index(face[0])], colors[faces.index(face[1])], colors[faces.index(face[2])]])
        face_middle_img = append_images([colors[faces.index(face[3])], colors[faces.index(face[4])], colors[faces.index(face[5])]])
        face_bottom_img = append_images([colors[faces.index(face[6])], colors[faces.index(face[7])], colors[faces.index(face[8])]])
